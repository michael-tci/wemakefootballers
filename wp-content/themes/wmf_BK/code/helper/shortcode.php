    ...
    <div class="container">
      <div class="row text-center home_footer_search">
        ...
        <form class="col-sm-16 post_selector">
          <input data-type="postcode" class="form-control input-postcode-site-3 postcode-plugin-val" placeholder="Enter your postcode" name="post_code">
          <button type="submit" class="postcode-plugin">go</button>
        </form>
      </div>
    </div>
  </div>');
    ...
    <div class="container">
      <div class="row text-center home_footer_search">
        ...
        <form class="col-sm-16 academy_selector" onsubmit="return false;">
			...
			<option value="https://www.wemakefootballers.com/isleworth/">Isleworth Academy</option>
			<option value="https://www.wemakefootballers.com/hounslow/">Hounslow Academy</option>
			<option value="https://www.wemakefootballers.com/twickenham/">Twickenham Academy</option>
			<option value="https://www.wemakefootballers.com/richmond/">Richmond Academy</option>
			<option value="https://www.wemakefootballers.com/chiswick/">Chiswick Academy</option>
			<option value="https://www.wemakefootballers.com/carshalton/">Carshalton Academy</option>
			<option value="https://www.wemakefootballers.com/sheen/">Sheen Academy</option>
			<option value="https://www.wemakefootballers.com/purley/">Purley Academy</option>
			<option value="https://www.wemakefootballers.com/southall/">Southall Academy</option>
          </select>
    ...
    <div class="container">
      <div class="row text-center holiday_academies">
        <form class="col-sm-16" onsubmit="return false;">
            ...
            <option value="">Select an accedmy </option>
			<option value="https://www.wemakefootballers.com/isleworth/">Isleworth </option>
			<option value="https://www.wemakefootballers.com/hounslow/">Hounslow </option>
			<option value="https://www.wemakefootballers.com/twickenham/">Twickenham </option>
			<option value="https://www.wemakefootballers.com/richmond/">Richmond </option>
			<option value="https://www.wemakefootballers.com/chiswick/">Chiswick </option>
			<option value="https://www.wemakefootballers.com/carshalton/">Carshalton </option>
			<option value="https://www.wemakefootballers.com/sheen/">Sheen </option>
			<option value="https://www.wemakefootballers.com/purley/">Purley </option>
			<option value="https://www.wemakefootballers.com/southall/">Southall </option>
          </select>
          </div>
        </form>
      </div>
