...
<div id="primary" class="content-area wmf-news">
    ...
    <div class="row <?php echo $counter; ?>">
        <div class="section-twocol section-twocol-full image-height-control">
            <div class="section-twocol-table">
                ...
                <div class="section-twocol-col section-twocol-col-image" data-aos="fade-left">
        ...
        <!-- section-all-row END  -->
        <div class="section-background-colstwo" style="background:url(<?php if(get_sub_field('method_second_background_image')) : echo get_sub_field('method_second_background_image'); else: echo site_url().'/wp-content/uploads/sites/42/2017/06/4E7A1641-copy.jpg)'; endif; ?>">
            <div class="container">
