  	...
  	<div class="top-join-sec">
		...
		<div class="sectionsetscroll slidersectionjoinus">
			<div class="content-wrapper">
				...
				<div id="myCarousel_joinus" class="carousel slide" data-ride="carousel">
					<div class="indicatorsjoinus">
						<?php
							$why_join_us = array(
						...
						<ol class="carousel-indicators">
							<?php for($i=0; $i<=$slide_why_join-1; $i++){ ?>
								<li data-target="#myCarousel_joinus" data-slide-to="<?php echo $i; ?>" class="<?php if($slide_why_join_counter ==1 ): echo "active"; endif; ?>"></li>						    
							<?php $slide_why_join_counter++; } ?>
						</ol>
				  ...
				  <!-- Wrapper for slides -->
					<div class="carousel-inner">
					  	<?php if($get_why_join_us->have_posts()) : $counter_why_join =1; while($get_why_join_us->have_posts()) : $get_why_join_us->the_post(); ?>
						    <div class="item <?php if($counter_why_join == 1) : echo "active"; endif; ?>">
						      <div class="slidersectionjoinus-col">
									<div class="slidersectionjoinus-left">
										<div class="slidersectionjoinusimg">
											<img src="<?php echo get_the_post_thumbnail_url(); ?>" alt="icon">
										</div>
									</div>
									<div class="slidersectionjoinus-right">
										<div class="slidersectionjoinus_content">
											<h4><?php the_title(); ?></h4>
											<p><?php the_content(); ?></p>
										</div>
									</div>
