  ...
  <div class="row">
    ...
    <div class="col-md-6 header-local-right">
      <div class="col-md-8 col-lg-8 contact" style="padding-top:20px;">
        ...
        <span style="color:#ee7925;font-size:15px;display:block;"><a href="tel:<?php echo get_settings('gss_getintouch_phone'); ?>" >Phone : <?php echo get_settings('gss_getintouch_phone'); ?></a></span>
      </div>
