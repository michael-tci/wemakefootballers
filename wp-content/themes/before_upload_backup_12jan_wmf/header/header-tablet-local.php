<div class="wmf-navbar-header navbar text-center visible-xs-block visible-sm-block">
  ...
  <?php
    ...
    printf('<a href="%s" class="wmf-navbar-header-logo-local"><img src="%s" alt="" class="center-block img-responsive"/>%s</a>', get_site_url(), $wmf_navbar_logo_link, get_bloginfo('name'));
  ?>
