window.cfields = {"67":"select_an_academy","62":"childs_name","74":"childs_dob2","64":"medical_information_for_child","65":"do_you_have_any_siblings_or_friends_you_would_like_to_book_a_free_trial_for_too","69":"communication_preferences"};
window._show_thank_you = function(id, message, trackcmp_url) {
  ...
  if (typeof window._form_callback !== 'undefined') window._form_callback('_form_4_');
};
...
(function() {
  ...
  _load_script("//cdnjs.cloudflare.com/ajax/libs/moment.js/2.13.0/moment.min.js", function() {
    _load_script("/wp-content/themes/wmf/assets/img/tmp/pikaday.js", function() {
