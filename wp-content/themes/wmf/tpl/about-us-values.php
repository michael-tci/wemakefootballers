...
get_header(); ?>
	...
	<div class="our-value-section">
		<div class="container">
				...
				<div class="col-sm-4section">
					<div class="sectioncolsm-image"><?php if( get_field('fun_bg')) : ?><img src="<?php echo get_field('fun_bg'); ?>"/><?php endif; ?></div>
					<div class="our-value-inner devlop">
						<a href="#funpart" id="funlink"></a>
						<img src="<?php if(get_field('fun_icon')) : echo get_field('fun_icon'); else: echo site_url().'/wp-content/themes/wmf/assets/img/safety-icon.png'; endif; ?>" alt="icon"/>
						<h3><?php the_field('fun_name'); ?></h3>
					</div>
				</div>
			...
			<div class="text-center">
				<div class="btn btn-primary">
					<a data-toggle="modal" data-target="#myModal_popup" href="javascript:void(0);">
				...
				<?php elseif( $counter == 2 ): ?>
					<div class="animation-draw-sec animright">
						...
						<div class="revercethis">
								...
								<div class="bottom-left-right-line"></div>
								<div class="bottom-right-line"></div>
								<div class="top-bottom-left-line" style="margin-top: 85px;"></div>
							</div>
						<!-- <div class="left-bottom-left-line-dotted"></div>
						<div class="top-right-left-line"></div>
						<div class="top-bottom-left-line"></div> -->
...
<!-- New code -->
<div class="section-all-row heaerprttp linepartanim darkthemthispart sectiondevicelineups" id="funpart">
<div class="container">
	<h3 class="aboutsession-titlese"><?php the_field('fun_name'); ?></h3>
	<?php if(have_rows('fun_points')) : $counter =1 ; while(have_rows('fun_points')) : the_row(); ?>
		<?php if( $counter == 1 ) : ?>
			<div class="animation-draw-sec">
				<div class="animation-draw-sec-inset">
					<div class="top-left-line"></div>
					...
					<div class="bottom-right-line"></div>
					<div class="animation-draw-sec-icon">
						<img src="<?php if(get_sub_field('fun_point_icon')) : echo get_sub_field('fun_point_icon'); else: echo site_url().'/wp-content/themes/wmf/assets/img/policies-icon.png'; endif; ?>" alt="icon"/>
					</div>
					<div class="animation-draw-content"><?php the_sub_field('Fun_point_content'); ?></div>
				</div>
			</div>
		<?php elseif( $counter == 2 ): ?>
			<div class="animation-draw-sec animright">
				<div class="animation-draw-sec-inset">
					...
					<div class="animation-draw-content padding-top35"><?php the_sub_field('Fun_point_content'); ?></div>
				</div>
			</div>
		<?php endif; ?>
	<?php $counter++; endwhile; endif; wp_reset_postdata(); ?>
	...
	<!-- <div class="section-all-row heaerprttp linepartanim developmentparts darkthemthispart sectiondevicelineups" id="developmentpart">
		<div class="container">
			<h3 class="aboutsession-titlese"><?php the_field('fun_name'); ?></h3>
			<?php if(have_rows('fun_points')) : $counter =1 ; while(have_rows('fun_points')) : the_row(); ?>
				<?php if( $counter == 1 ) : ?>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#safetylink, #passionlink, #developlink, #funlink').on('click', function(event) {
