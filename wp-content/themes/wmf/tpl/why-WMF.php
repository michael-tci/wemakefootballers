  		...
  		<div class="container">
  			<div class="our-goals-wmfinnner">
  				<div class="row">
  					...
  					<?php if(have_rows('football_coaching_companies_in_the_uk')) : $counter_coach = 1; while(have_rows('football_coaching_companies_in_the_uk')) : the_row(); ?>
	  					<div class="col-md-4">
	  						<div class="our-goals-wmf-col">
	  							<div class="our-goals-wmf-col-img">
	  								<img src="<?php if(get_sub_field('coaching_companies_image')) : echo get_sub_field('coaching_companies_image'); else: echo site_url().'/wp-content/themes/wmf/assets/img/slide3.jpg'; endif;  ?>" alt="icon">
	  							</div>
	  							<div class="hedlinssdad"><?php the_sub_field('coaching_companies_name'); ?></div>
	  							<?php if($counter_coach == 1) : ?>
		  							<div class="btn btn-primary">
		  								<a href="javascript:void(0);" data-toggle="modal" data-target="#myModal_popup"><?php the_sub_field('comp_button_text'); ?>	  								
		  								</a>
		  							</div>
		  						<?php else: ?>
		  							<div class="btn btn-primary">
		  								<a href="<?php echo site_url().'/join-us/'; ?>"><?php the_sub_field('comp_button_text'); ?></a>
		  							</div>
		  						<?php endif; ?>
	  						</div>
	  					</div>  
	  				<?php $counter_coach++; endwhile; endif; ?>					
  				</div>
  			</div>
  		</div>
