<?php
/*
Template Name: Join us Chiswick
*/
...
get_header('local'); ?>
  ...
  <div id="primary" class="content-area join-us">
		  	...
		  	<div class="container">
		  		...
		  		<div class="text-center">
		  			...
		  			<h2 class="pagetitlename">
		  				<?php if(get_field('join_us_careers_heading')) : echo get_field('join_us_careers_heading'); else: echo ""; endif; ?>		  					
		  			</h2>
		  			<p><?php the_field('join_us_careers_content'); ?></p>
		  			<div class="apply-coach-inner">
							<div class="btn-view-training coach-apply">
								<a class="btn btn-default" href="<?php if(get_field('coach_button_link')) : echo get_field('coach_button_link'); else: echo "#"; endif; ?>">
									<?php if(get_field('coach_button_text')) : echo get_field('coach_button_text'); else: echo "string"; endif; ?>									
								</a>
							</div>
							<div class="btn-view-training coach-service-apply"><a class="btn btn-default" href="<?php if(get_field('customer_service_role_button_link')) : echo get_field('customer_service_role_button_link'); else: echo "#"; endif; ?>"><?php if(get_field('customer_service_role_text')) : echo get_field('customer_service_role_text'); else: echo "Apply For a customer service role"; endif; ?></a></div>
						</div>
		  		</div>
	...
	<div class="vacancies-section fulwraper ">
		<div class="section-all-row vacancies-heading aos-init aos-animate" data-aos="fade-up">
		  	<div class="container">
		  		<div class="vacancies-heading-inner">
		  			<h2 class="pagetitlename"><?php the_field('vacancies_heading'); ?></h2>
			...
			<div class="apply-inner-section" style="background-image: url(<?php if(get_field('apply_for_a_coaching_position_image')) : echo get_field('apply_for_a_coaching_position_image'); else: echo site_url().'/wp-content/themes/wmf/assets/img/holiday-camp-header.jpg'; endif; ?>);">
				<div class="apply-txt-inner">
					...
					<div class="btn-view-training">
						<a class="btn btn-default" href="<?php if(get_field('apply_for_a_coaching_position_button_link')) : echo get_field('apply_for_a_coaching_position_button_link'); else : echo "#"; endif; ?>">
		...
		<div class="col-sm-6">
			<div class="apply-inner-section apply-inner-section-2" style="background-image: url(<?php if(get_field('parent_host_image')) : echo get_field('parent_host_image'); else: echo site_url().'/wp-content/themes/wmf/assets/img/holiday-camp-bg.png'; endif; ?>);">
				<div class="apply-txt-inner">
					...
					<div class="btn-view-training">
						<a class="btn btn-default" href="<?php if(get_field('parent_host_button_link')) : echo get_field('parent_host_button_link'); else: echo "#"; endif; ?>">
