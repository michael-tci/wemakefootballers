...
get_header(); ?>
  ...
  <div id="primary" class="content-area wmf-news container-fluid">
    <main id="main" class="site-main row" role="main">
    	<?php /* <div class="page-header-pages">
    		<div class="container">
    	...
    	<div class="section-all-row heaerprttp">
            <div class="container">
                <div class="text-center">
                    <div class="iconof-pgtitle"><img src="<?php if(get_field('header_title_icon')) : echo get_field('header_title_icon'); else : echo get_stylesheet_directory_uri().'/assets/img/goals-achivement-icon.png'; endif;?>" alt="icon"></div>

                    <h1 class="pagetitlename">
                        <?php if(get_field('header_content')) : ?><?php echo get_field('header_content'); ?><?php endif; ?>
                    </h1>
				...
				<div class="oneonone-sec" data-aos="fade-up">
					<div class="row">
						...
						<div class="col-md-8 inmobilenone">
							<div class="imagecol-secc secondth text-left">
								<div>
									<img src="<?php if(get_field('extra_support_section_image')) : echo get_field('extra_support_section_image'); else: echo site_url().'/wp-content/uploads/2015/10/04d_121-training_JR_07.jpg'; endif;?>" alt="image"/>
								</div>
							</div>
						</div>
					</div>
