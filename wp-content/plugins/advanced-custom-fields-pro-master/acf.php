...
class acf {
	...
	*/
	...
	function register_assets() {
		...
		// scripts
		wp_register_script('acf-input', acf_get_dir("asset/js/acf-input{$min}.js"), array('jquery', 'jquery-ui-core', 'jquery-ui-sortable', 'jquery-ui-resizable'), $version );
		wp_register_script('acf-field-group', acf_get_dir("asset/js/acf-field-group{$min}.js"), array('acf-input'), $version );


		// styles
		wp_register_style('acf-global', acf_get_dir('asset/css/acf-global.css'), array(), $version );
		wp_register_style('acf-input', acf_get_dir('asset/css/acf-input.css'), array('acf-global'), $version );
		wp_register_style('acf-field-group', acf_get_dir('asset/css/acf-field-group.css'), array('acf-input'), $version );
