...
//New Function 
function get_the_category_list_new( $separator = '', $parents = '', $post_id = false ) {
	global $wp_rewrite;
	if ( ! is_object_in_taxonomy( get_post_type( $post_id ), 'category' ) ) {
		/** This filter is documented in wp-includes/category-template.php */
		return apply_filters( 'the_category', '', $separator, $parents );
...
function the_new_category( $separator = '', $parents = '', $post_id = false ) {
	echo get_the_category_list_new( $separator, $parents, $post_id );
}
